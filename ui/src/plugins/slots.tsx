 ...
 *
 * Plugin bundles are built with `external: ["@agentdash/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@agentdash/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@agentdash/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@agentdash/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@agentdash/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@agentdash/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@agentdash/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
