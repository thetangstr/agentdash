...
Low-level reference for how AgentDash packages are prepared and published to npm.
...
AgentDash no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `agentdash`, imports code from workspace packages such as:
...
AgentDash uses calendar versions:
