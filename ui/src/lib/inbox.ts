...
export const DISMISSED_KEY = "agentdash:inbox:dismissed";
export const READ_ITEMS_KEY = "agentdash:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "agentdash:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "agentdash:inbox:issue-columns";
