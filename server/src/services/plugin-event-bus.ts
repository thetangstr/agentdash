/**
 * PluginEventBus — typed in-process event bus for the AgentDash plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@agentdash/shared";
import type { PluginEvent, EventFilter } from "@agentdash/plugin-sdk";
