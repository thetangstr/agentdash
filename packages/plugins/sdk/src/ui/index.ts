/**
 * `@agentdash/plugin-sdk/ui` — AgentDash plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@agentdash/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@agentdash/plugin-sdk/ui";
 *
