...
- **`id`**: Unique identifier, used as the npm package name suffix (`@agentdash/mod-observability`)
...
```typescript
import type { ModuleAPI } from "@agentdash/core";
...
export const modulePages = [
  {
    path: "/observability",
    label: "Observability",
    component: lazy(() => import("@agentdash/mod-observability/ui")),
  },
];
...
export const dashboardWidgets = [
  {
    ...
    label: "Token Burn Rate",
    placement: "dashboard",
    component: lazy(() => import("@agentdash/mod-observability/ui").then(m => ({ default: m.TokenBurnRateWidget }))),
  },
];
```
...
| **Multi-tenant** | Separate companies/orgs within one AgentDash instance | `server:started` |
...
10. **`@agentdash/module-sdk`** — TypeScript types for `ModuleAPI`, `HookEvent`, `HookHandler`, manifest schema
