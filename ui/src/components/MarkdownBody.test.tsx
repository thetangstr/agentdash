...
import { buildAgentMentionHref, buildProjectMentionHref, buildSkillMentionHref } from "@agentdash/shared";
...
describe("MarkdownBody", () => {
  ...
  it("renders agent, project, and skill mentions as chips", () => {
    const html = renderToStaticMarkup(
      <ThemeProvider>
        <MarkdownBody>
          {`[@CodexCoder](${buildAgentMentionHref("agent-123", "code")}) [@AgentDash App](${buildProjectMentionHref("project-456", "#336699")}) [/release-changelog](${buildSkillMentionHref("skill-789", "release-changelog")})`}
        </MarkdownBody>
      </ThemeProvider>,
    );
