...
If your Linear team name is not `AgentDash`, update the `team:` examples in the command docs.

## Primary Commands

- `/workon AGE-123`: run the full PM -> Builder -> Tester flow for one issue
- `/builder AGE-123`: jump directly to implementation
- `/tester AGE-123`: run the testing workflow for an issue/PR
