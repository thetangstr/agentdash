      ...
      <CardContent className="space-y-4">
        ...
        <dl className="grid grid-cols-3 gap-3 text-sm">
          ...
          <div>
            ...
            <dd className="tabular-nums">{latest.interventions == null ? <span className="text-xs text-muted-foreground">not on this card</span> : latest.interventions}</dd>
          </div>
          <div>
            <dt className="text-[11px] uppercase tracking-wide text-muted-foreground">Metered cost</dt>
            <dd className="tabular-nums">{latest.costCents == null ? <span className="text-xs text-muted-foreground">not on this card</span> : fmtCents(latest.costCents)}</dd>
          </div>
        </dl>
