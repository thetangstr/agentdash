...
import type { IssueRelationIssueSummary } from "@agentdash/shared";
import { extractAgentMentionIds, extractProjectMentionIds, isUuidLike } from "@agentdash/shared";
...
export function issueService(db: Db) {
  ...
  return {
    ...
    update: async (
      ...
      // AgentDash: auto-unblock dependents when issue completes
