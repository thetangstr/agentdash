...
The AgentDash CLI handles instance setup, diagnostics, and control-plane operations.
...
```sh
# Set defaults
pnpm agentdash context set --api-base http://localhost:3100 --company-id <id>
