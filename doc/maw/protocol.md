...
|-------|---------|-------|-------|
| Intake -> Tested | `/workon AD-XXX` | Orchestrator (workspace-scoped) | PM -> Builder -> Deploy + Smoke -> Tester (auto + chrome) |
