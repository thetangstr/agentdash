...
describe("adapter routes", () => {
  ...
  it("GET /api/adapters returns correct capabilities for built-in adapters", async () => {
    ...
    // hermes_local supports skills + local JWT and (since AGE-8) the managed
    // instructions bundle: the registry wrapper injects the bundle entry file
    // into the live prompt at execute time.
