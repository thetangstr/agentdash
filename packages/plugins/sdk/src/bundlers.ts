/**
 * Bundling presets for AgentDash plugins.
 *
 ...
 * to match the AgentDash plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@agentdash/plugin-sdk/ui",
    "@agentdash/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
