...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@agentdash/db";
import type {
  PluginStatus,
...
import type { ToolRunContext } from "@agentdash/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@agentdash/plugin-sdk";
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@agentdash/plugin-hello-world-example",
    pluginKey: "agentdash.hello-world-example",
    displayName: "Hello World Widget (Example)",
    description: "Reference UI plugin that adds a simple Hello World widget to the AgentDash dashboard.",
    localPath: "packages/plugins/examples/plugin-hello-world-example",
    tag: "example",
  },
  {
    packageName: "@agentdash/plugin-file-browser-example",
    pluginKey: "agentdash-file-browser-example",
  ...
  {
    packageName: "@agentdash/plugin-kitchen-sink-example",
    pluginKey: "agentdash-kitchen-sink-example",
    displayName: "Kitchen Sink (Example)",
    description: "Reference plugin that demonstrates the current AgentDash plugin API surface, bridge flows, UI extension surfaces, jobs, webhooks, tools, streams, and trusted local workspace/process demos.",
...
export function pluginRoutes(
   ...
   *   {
   *     "pluginId": "plg_123",
   *     "pluginKey": "agentdash.claude-usage",
