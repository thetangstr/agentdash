...
> **Note:** If you used `npx` for setup, always use `npx agentdash` to run commands. The `pnpm agentdash` form only works inside a cloned copy of the Paperclip repository (see Local Development below).
