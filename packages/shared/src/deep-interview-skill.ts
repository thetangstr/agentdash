// AUTO-GENERATED by scripts/sync-skill-md.mjs — DO NOT EDIT BY HAND.
//
// Pinned upstream OMC version: 4.13.5
// SKILL.md sha256/16:           89e8a38fd4a884b5
// Summary sha256/16:            26f423e1dbd391de
// Summary source:               hand-curated-fallback
//
...
export const SKILL_MD_SOURCE_VERSION = "4.13.5" as const;

export const SKILL_MD_FULL: string = `---
name: deep-interview
...
export const SKILL_MD_SUMMARY: string = `# Deep Interview — Methodology Summary
